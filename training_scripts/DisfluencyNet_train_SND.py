...
# get all data
train_path_stutter = 'train_data/snd'
train_path_fluent  = 'train_data/fluent'
test_path_stutter  = 'test_data/snd'
...
writer = SummaryWriter("wav2vec_base_model_quart_data_snd")
writer = SummaryWriter(comment="Quart dataset for binary classification sound repetion;")
##################################################################################################
# wav2vec2.0
